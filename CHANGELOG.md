...
- Files: `logger.py`, `main.py`, `settings_dialog.py`, `logging_guide.md`, `logging_architecture.md`, `logging_features.md`, `logging_implementation_plan.md`
- Capabilities:
...
- Settings UI:
  - New Logging tab (in `settings_dialog.py`): toggle each log stream, enable Debug Mode, configure auto-cleanup and retention, and run manual cleanup
- Best practices:
...
- Files: `estimate_entry.py`, `estimate_entry_logic.py`, `estimate_entry_ui.py`, `DOCS/estimate_loading_architecture.md`, `DOCS/estimate_loading_fix.md`
- Changes:
...
- Files: `login_dialog.py`, `database_manager.py`, `DOCS/security-architecture.md`
- Key elements:
...
- Files: `database_manager.py`, `DOCS/data-model-relationships.md`
...
- Files: `database_manager.py`, `estimate_entry_logic.py`, `silver_bar_management.py`, `print_manager.py`
...
- Files: `estimate_entry.py`, `estimate_entry_ui.py`, `estimate_entry_logic.py`, `DOCS/workflow-business-logic.md`
- Calculations:
...
## Testing Strategy and CI (May 2025)

- Summary: Multi-level testing with focus on calculations, persistence, and UI behavior.
- Files: `DOCS/testing-strategy.md`
