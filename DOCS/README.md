...
for the v3.06 source tree. Packaged releases support Windows 10/11; macOS and
...
| [Data model and relationships](data-model-relationships.md) | Schema v6 tables, foreign keys, indexes, and migration history |
