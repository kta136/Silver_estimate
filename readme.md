...
[![Source Version](https://img.shields.io/badge/source-v3.04-orange.svg)](CHANGELOG.md#304---2026-07-16)
...
- [v3.04 changelog](CHANGELOG.md#304---2026-07-16)
...
- Output: `dist/SilverEstimate.exe`, `dist/SilverEstimate-v3.04.exe`, and `dist/SilverEstimate-v3.04-win64.zip` on Windows
